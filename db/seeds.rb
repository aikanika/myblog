...
3.times do |i|
   Post.create(title:"title 1-#{i}",body:"body 1-#{i}",category_id: "1")
end
2.times do |i|
   Post.create(title:"title 2-#{i}",body:"body 2-#{i}",category_id: "2")
end
4.times do |i|
   Post.create(title:"title 3-#{i}",body:"body 3-#{i}",category_id: "3")
end
